...
// Feature: E Signature
// Description: E-signature / acknowledgement tracking for compliance docs
  ...
  try {
    const r = await fetch('https://openrouter.ai/api/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          { role: 'system', content: 'You are an expert assistant for: E Signature. E-signature / acknowledgement tracking for compliance docs' },
