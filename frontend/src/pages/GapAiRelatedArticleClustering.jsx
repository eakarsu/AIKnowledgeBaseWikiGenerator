...
// Ai Related Article Clustering
// (semantic similarity / dedupe)

export default function GapAiRelatedArticleClustering() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-ai-related-article-clustering', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Ai Related Article Clustering</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>(semantic similarity / dedupe)</p>
      ...
      <div style={{ background: '#fff', border: '1px solid #e5e7eb', borderRadius: 8, padding: 20, marginBottom: 20 }}>
        ...
        <div style={{ marginTop: 12, display: 'flex', gap: 8 }}>
          ...
          >
            {loading ? 'Running...' : 'Run Ai Related Article Clustering'}
          </button>
          <button
