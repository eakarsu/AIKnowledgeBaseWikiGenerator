...
// Approval
// Approval workflows for sensitive docs (no review pipeline)

export default function GapApproval() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-approval', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Approval</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Approval workflows for sensitive docs (no review pipeline)</p>
