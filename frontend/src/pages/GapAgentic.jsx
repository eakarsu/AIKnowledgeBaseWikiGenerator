...
// Agentic
// Agentic KB health monitor that triages staleness, broken links, orphan articles
...
export default function GapAgentic() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      ...
      <p style={{ color: '#555', marginBottom: 20 }}>Agentic KB health monitor that triages staleness, broken links, orphan articles</p>
