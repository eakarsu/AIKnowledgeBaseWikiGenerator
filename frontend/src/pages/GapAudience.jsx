...
// Audience
// Audience segmentation (role-based KB views)

export default function GapAudience() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-audience', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Audience</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Audience segmentation (role-based KB views)</p>
